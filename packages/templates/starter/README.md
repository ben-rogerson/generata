...
3. Add workflows in `agents/workflows/` (the convention) - flat placement directly in `agents/` also works - and they'll show up in `pnpm generata help workflows`.
4. Run `pnpm generata commands sync` after adding workflows to refresh `.claude/commands/`.
