...
- 9bcd198: fix: handle non-Error throws in main catch handler
...
- 9768617: fix(core): detect bun.lock text lockfile alongside bun.lockb
...
- d6460d9: fix(core): use schema defaults for fallback config in resolveConfigAndCwd
...
- 43d9d5f: fix(cli): stop boolean flags consuming the next positional argument
...
- d7ab3df: fix(core): skip malformed JSONL lines in readMetrics
- aed48b3: fix: re-prompt required env variables until non-empty
